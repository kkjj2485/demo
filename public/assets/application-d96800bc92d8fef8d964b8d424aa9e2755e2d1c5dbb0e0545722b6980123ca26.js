...
$(<span style="color: #007020;">document</span>).ready(<span style="color: #008000; font-weight: bold;">function</span>() {
	$(<span style="background-color: #fff0f0;">':input'</span>).blur(<span style="color: #008000; font-weight: bold;">function</span> () {
		...
		<span style="color: #008000; font-weight: bold;">else</span> {
			_gaq.push([<span style="background-color: #fff0f0;">'_trackEvent'</span>, <span style="background-color: #fff0f0;">'phone'</span>, <span style="background-color: #fff0f0;">'skipped'</span>, $(<span style="color: #008000; font-weight: bold;">this</span>).attr(<span style="background-color: #fff0f0;">'name'</span>)]);
